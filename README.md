...
Select an officer in the world overview, then use the glasses view to inspect what that officer can see. Directly observed targets appear normally; targets observed by teammates can appear as shared outlines through walls when within the selected officer's viewing direction and range. Disable shared vision to compare the views. When no officer can see a target, its shared outline disappears.
